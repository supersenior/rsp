    ...
    return (
      `<div className="wt-new-project-wizard__step wt-new-project-wizard__step--one">
        ...
        <div className="wt-formfield">
          ...
          <input type="text" value={this.state.employerName} onChange={this._setEmployerName} />

          <label>Effective Date</label>
          <input type="date" value={this.state.effectiveDate} onChange={this._setEffectiveDate} placeholder='mm/dd/yyyy'/>
